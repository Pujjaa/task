...
import seachIcon from "../../img/search-11-1@2x.png";
import commentImg from "../../img/bell-1-1@2x.png";
import userImg from "../../img/ellipse-19@2x.png";
import arrowDownImg from "../../img/arrowdownsigntonavigate-2-1@2x.png";
import reportImg from "../../img/writing-1@2x.png";
import epxortImg from "../../img/import-1@2x.png";
import skyIcon from "../../img/sky-1@2x.png";
import userIcon from "../../img/user-16-1@2x.png";
import rightIcon from "../../img/rightarrow-11-1@2x.png";
import coin from "../../img/2953383-1@2x.png";
import week from "../../img/nextweek-1@2x.png";
import ruppe from "../../img/rupeeindian-1@2x.png";
  ...
  return (
    <div className={styles.mainContainer}>
      ...
      <div className={styles.good}>
        <span className={styles.goodText}>Good Afternoon, Onkaresh</span>
      ...
      <div className={styles.graph}>
        <h3>Viewership Installs & Signups Graph</h3>
          ...
          <>
            {obj.price !== undefined ? (
              ...
              <div className={styles.renewal}>
                ...
                <div>{obj.upcome?.map((item) => (
                          <div className={styles.upcome} key={item.id}>
                            <div>
                                <span className={styles.moneyValueName}>
                              {item.name}
                            </span>
                            <span
                              className={styles.valText}
                              style={{ background: item.color }}
                            >
                              {item.value}
                            </span>
                            </div>
                            <div className={styles.priceRen}>
                                <img src={ruppe} className={styles.rupRen} />
                              {item.price}
                            </div>
                          </div>
                        ))}
